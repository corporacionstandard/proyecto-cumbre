...
use Saving\BoxBundle\Entity\Persona;
use Saving\BoxBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SavingBoxBundle:Persona')->findAll();
     ...
     * @Method("POST")
     * @Template("SavingBoxBundle:Persona:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SavingBoxBundle:Persona')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SavingBoxBundle:Persona:edit.html.twig")
     */
